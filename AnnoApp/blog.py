...
def index():
    ...
    return render_template('blog/index.html', texts=texts)
...
def annotate(id):
    ...
    if request.method == 'GET':
        ...
        return render_template(f'blog/annotate_{id}.html', text=word_list, annotation_exist=annotation, ID=id)
...
def update(id):
    ...
    return render_template('blog/update.html', text=text)
